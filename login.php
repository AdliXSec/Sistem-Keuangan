        ...
        <div class="grid md:grid-cols-2 items-center gap-4 max-w-6xl w-full">
          <div class="border border-gray-300 rounded-lg p-6 max-w-md shadow-[0_2px_22px_-4px_rgba(93,96,127,0.2)] max-md:mx-auto">
            <form class="space-y-4" method="post">
              ...
              <p class="text-sm !mt-8 text-center text-gray-800">Don't have an account <a href="registrasi.php" class="text-blue-600 font-semibold hover:underline ml-1 whitespace-nowrap">Register here</a></p>
            </form>
            <?php
            if (isset($_POST['submit'])) {
              $usermail = $_POST['usermail'];
              $password = md5($_POST['password']);
              $sql = "SELECT * FROM user WHERE email_user = '$usermail' AND password_user = '$password'";
              ...
              if (mysqli_num_rows($result) > 0) {
                ...
                $_SESSION['saldo_user'] = $row['saldo_user'];
