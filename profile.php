...
<body class="container mx-auto bg-blue-500 text-black min-h-screen">
  ...
  <main class="container opacity-80 mx-auto absolute z-20 mt-4 p-4">
    <div class="bg-white shadow-md rounded-lg p-4">
      ...
      <img src="img/<?=$row['image_user']?>" alt="" class="w-[70px] h-[70px] rounded-full">
        ...
        <div class="py-2 px-4">
          ...
          <form action="" method="post">
            ...
            <div class="mb-4">
                ...
                <input class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer dark:text-gray-400 focus:outline-none bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" aria-describedby="user_avatar_help" id="user_avatar" type="file">
            </div>
            <div class="mb-4 flex">
  ...
  <div class="bg-white text-black p-4 gap-4 h-[400px]">
    <div class="p-2">
